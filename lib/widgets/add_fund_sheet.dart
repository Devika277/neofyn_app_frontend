...
class _ManualFundFormState extends State<_ManualFundForm> {
  ...
  Future<void> _submit() async {
    ...
    if (_selectedDate == null) {
      _showError('Please select payment date');
      return;
    }
    ...
    return Consumer<BankProvider>(
      builder: (context, bankProvider, child) {
          ...
          return Column(
            children: [
              ...
              TextButton.icon(
                ...
                icon: const Icon(Icons.refresh, color: Color(0xFF00FF9D), size: 18),
                label: const Text(
                  'Retry',
        ...
        return Wrap(
          spacing: 8,
          runSpacing: 8,
          children: bankProvider.banks.map((bank) {
            ...
            return GestureDetector(
              ...
              child: Container(
                ...
                child: Text(
                  bank.name,
                  style: TextStyle(
                    color: isSelected ? const Color(0xFF00FF9D) : Colors.white60,
                    fontSize: 13,
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          if (bank.accountType != null) _detailRow('Account Type', bank.accountType!),
          const SizedBox(height: 8),
          GestureDetector(
            onTap: () {
