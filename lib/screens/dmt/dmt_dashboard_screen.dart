      ...
      appBar: AppBar(
        ...
        actions: [
          Container(
            ...
            child: IconButton(
              icon: Icon(
                _isRefreshing ? Iconsax.refresh_circle : Iconsax.refresh,
                color: AppColors.textWhite,
                size: 20,
              ),
            ...
            children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        const Icon(Iconsax.call, size: 12, color: Colors.white70),
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    Icon(
                      _remitter!.productType == 'lite' ? Iconsax.wallet_3 : Iconsax.crown,
                      size: 14,
                      color: Colors.white,
                    ),
                    const SizedBox(width: 4),
            ...
            children: [
              Expanded(
                child: _buildLimitItem(
                  label: 'Monthly Limit',
                  amount: '₹${_remitter!.monthlyLimit.toStringAsFixed(0)}',
              ...
              Expanded(
                child: _buildLimitItem(
                  label: 'Remaining',
                  amount: '₹${remainingLimit.toStringAsFixed(0)}',
              ...
              Expanded(
                child: _buildLimitItem(
                  label: 'Used',
                  amount: '₹${_remitter!.monthlyUsed.toStringAsFixed(0)}',
            ...
            children: [
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: GoogleFonts.poppins(
                      fontSize: 13,
                      fontWeight: FontWeight.w700,
                      color: isHighUsage ? AppColors.warning : Colors.white,
                    ),
                  ),
                ],
              ),
              ...
              ClipRRect(
                ...
                child: LinearPercentIndicator(
                  ...
                  progressColor: isHighUsage ? AppColors.warning : Colors.white,
              ...
              const SizedBox(height: 8),
              Text(
                '₹${_remitter!.monthlyUsed.toStringAsFixed(0)} of ₹${_remitter!.monthlyLimit.toStringAsFixed(0)} used',
                style: GoogleFonts.poppins(
                  fontSize: 11,
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      'Complete KYC to increase your transfer limits',
                      style: GoogleFonts.poppins(
                        fontSize: 12,
        ...
        children: [
          ...
          Text(
            ...
            style: GoogleFonts.poppins(
              fontSize: 16,
              fontWeight: FontWeight.w700,
              color: isRemaining ? AppColors.primaryLight : Colors.white,
            ),
            overflow: TextOverflow.ellipsis,
          ),
        ],
              ...
              _buildActionButton(
                ...
                onTap: () {
                  ...
                  if (_beneficiaries.isEmpty) {
                    _showSnackbar('Please add a beneficiary first', isError: true);
                    return;
                  }
                  Navigator.push(
                    context,
            ...
            child: InkWell(
              ...
              child: Padding(
                ...
                child: Row(
                  mainAxisSize: MainAxisSize.min,
                  children: [
                    Icon(Iconsax.add, size: 16, color: AppColors.primaryLight),
                    const SizedBox(width: 6),
                    Text(
                      'Add Beneficiary',
                      style: GoogleFonts.poppins(
